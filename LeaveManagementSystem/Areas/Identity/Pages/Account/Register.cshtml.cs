...
namespace LeaveManagementSystem.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            RoleList = _roleManager.Roles.Select(x => x.Name).Where(q=>q != SD.Role_Admin).ToArray();
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (Input.UserRole == SD.Role_Employee)
                    {
                        await _userManager.AddToRoleAsync(user, SD.Role_Employee);
                    }
                    else if(Input.UserRole == SD.Role_Supervisor)
                    {
                    ...
                    // here
                    _unitOfWork.LeaveAllocations.Add(userId);
